...
import { getCategories, getCategoryExercises, deleteCategory} from "../db/categories.ts";

const router = new Router();

export default router.get("/categories", async (context) => {
    try {
        ...
        context.response.body = { error: "Failed to fetch categories" };
    }
